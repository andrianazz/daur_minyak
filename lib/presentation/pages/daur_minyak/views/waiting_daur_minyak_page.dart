...
class WaitingDaurMinyakPage extends ConsumerStatefulWidget {
  const WaitingDaurMinyakPage({super.key});

  @override
  ConsumerState<WaitingDaurMinyakPage> createState() =>
      _WaitingDaurMinyakPageState();
}

class _WaitingDaurMinyakPageState extends ConsumerState<WaitingDaurMinyakPage> {
  bool isFind = false;
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          isFind == false ? const MenungguWidget() : const FindingPicker(),
          Align(
...
class MenungguWidget extends StatelessWidget {
